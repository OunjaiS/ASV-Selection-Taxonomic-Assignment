...
├── 4_NUMT_Codon_Usage_Analysis.py       # NUMT codon usage validation
├── 5_dada2_chimera_detection.R          # DADA2 chimera detection (R)
└── 6_DADA2_Benchmarking_Comparison.py  # DADA2 vs framework comparison
```
...
### 4. `4_NUMT_Codon_Usage_Analysis.py`
...
- Generates Supplementary Table S7 (`Table_S7_RSCU_comparison.csv`)
...
- These are used as input for `6_DADA2_Benchmarking_Comparison.py`
...
### 6. `6_DADA2_Benchmarking_Comparison.py`
...
# 4. python script/4_NUMT_Codon_Usage_Analysis.py
# 5. Rscript script/5_dada2_chimera_detection.R  → generates DADA2 chimera results (requires R)
# 6. python script/6_DADA2_Benchmarking_Comparison.py
```
...
| Code archive (Zenodo) | https://doi.org/10.5281/zenodo.18732406 |
